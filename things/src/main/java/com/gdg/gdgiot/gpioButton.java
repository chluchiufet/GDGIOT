...
public class gpioButton implements AutoCloseable {
    private static final String TAG = gpioButton.class.getSimpleName();
    ...
    public interface OnButtonEventListener {
         ...
         */
        void onButtonEvent(gpioButton button, boolean pressed);
    }
     ...
     * @throws IOException
     */
    public gpioButton(String pin, LogicState logicLevel) throws IOException {
     ...
     */
    @VisibleForTesting
    /*package*/ gpioButton(Gpio buttonGpio, LogicState logicLevel) throws IOException {
        connect(buttonGpio, logicLevel);
    }
